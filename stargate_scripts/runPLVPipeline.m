...
function runPLVPipeline
%%
mir_toolbox_path = '/work/mindlab/Programs/MIRtoolbox1.8.2';
addpath(mir_toolbox_path)
...
[outTable_GAM] = analysis_PLV('GAM','MBI',batch,params.anals.chans2use,subjectInfo,params);
disp(strcat("completed gamma conditions: ", subjectInfo.subjectID))
% save(fullfile(params.homedir,"allDataPAC_oneFreq_Gam"),"outTable_GAM");
[outTable_REG] = analysis_PLV('REG','MBI',batch,params.anals.chans2use,subjectInfo,params);
disp(strcat("completed regular conditions: ", subjectInfo.subjectID))
% HEI Participants
[outTable_GAM] = analysis_PLV('GAM','HEI', batch, params.anals.chans2use,subjectInfo,params);
disp(strcat("completed HEI gamma conditions: ", subjectInfo.subjectID))
[outTable_REG] = analysis_PLV('REG','HEI',batch,params.anals.chans2use,subjectInfo,params);
